...
% I sectioned out different parts so all the figures/plots aren't so
% overwhelming

% load all dewarped run data
...
run_1_letters = struct2array(load('run_1_letters.mat'));
run_2_letters = struct2array(load('run_2_letters.mat'));
run_3_letters = struct2array(load('run_3_letters.mat'));
run_4_letters = struct2array(load('run_4_letters.mat'));
run_5_letters = struct2array(load('run_5_letters.mat'));
run_6_letters = struct2array(load('run_6_letters.mat'));
run_7_letters = struct2array(load('run_7_letters.mat'));
run_8_letters = struct2array(load('run_8_letters.mat'));
run_9_letters = struct2array(load('run_9_letters.mat'));
run_10_letters = struct2array(load('run_10_letters.mat'));
run_11_letters = struct2array(load('run_11_letters.mat'));
run_12_letters = struct2array(load('run_12_letters.mat'));
run_13_letters = struct2array(load('run_13_letters.mat'));
run_14_letters = struct2array(load('run_14_letters.mat'));
run_15_letters = struct2array(load('run_15_letters.mat'));
run_16_letters = struct2array(load('run_16_letters.mat'));
run_17_letters = struct2array(load('run_17_letters.mat'));
run_18_letters = struct2array(load('run_18_letters.mat'));

%%
% pick which camera's data we want (A-D)
cam = "A";

% find out which images are from that camera
let1 = run_1_letters == cam;
let2 = run_2_letters == cam;
let3 = run_3_letters == cam;
let4 = run_4_letters == cam;
let5 = run_5_letters == cam;
let6 = run_6_letters == cam;
let7 = run_7_letters == cam;
let8 = run_8_letters == cam;
let9 = run_9_letters == cam;
let10 = run_10_letters == cam;
let11 = run_11_letters == cam;
let12 = run_12_letters == cam;
let13 = run_13_letters == cam;
let14 = run_14_letters == cam;
let15 = run_15_letters == cam;
let16 = run_16_letters == cam;
let17 = run_17_letters == cam;
let18 = run_18_letters == cam;

% get only that camera's surface elevation data
run_1 = run_1(:,let1);
run_2 = run_2(:,let2);
run_3 = run_3(:,let3);
run_4 = run_4(:,let4);
...
SWH1 = mean(sort1(round(2*length(run1)/3):length(run1)));

sort2 = sort(run2-mean(run2));
SWH2 = mean(sort2(round(2*length(run2)/3):length(run2)));

sort3 = sort(run3-mean(run3));
SWH3 = mean(sort3(round(2*length(run3)/3):length(run3)));

sort4 = sort(run4-mean(run4));
SWH4 = mean(sort4(round(2*length(run4)/3):length(run4)));

sort5 = sort(run5-mean(run5));
SWH5 = mean(sort5(round(2*length(run5)/3):length(run5)));

sort6 = sort(run6-mean(run6));
SWH6 = mean(sort6(round(2*length(run6)/3):length(run6)));

sort7 = sort(run7-mean(run7));
SWH7 = mean(sort7(round(2*length(run7)/3):length(run7)));

sort8 = sort(run8-mean(run8));
SWH8 = mean(sort8(round(2*length(run8)/3):length(run8)));

sort9 = sort(run9-mean(run9));
SWH9 = mean(sort9(round(2*length(run9)/3):length(run9)));

sort10 = sort(run10-mean(run10));
SWH10 = mean(sort1(round(2*length(run10)/3):length(run10)));

sort11 = sort(run11-mean(run11));
SWH11 = mean(sort11(round(2*length(run11)/3):length(run11)));

sort12 = sort(run12-mean(run12));
SWH12 = mean(sort12(round(2*length(run12)/3):length(run12)));

sort13 = sort(run13-mean(run13));
SWH13 = mean(sort13(round(2*length(run13)/3):length(run13)));

sort14 = sort(run14-mean(run14));
SWH14 = mean(sort14(round(2*length(run14)/3):length(run14)));

sort15 = sort(run15-mean(run15));
SWH15 = mean(sort15(round(2*length(run15)/3):length(run15)));

sort16 = sort(run16-mean(run16));
SWH16 = mean(sort16(round(2*length(run16)/3):length(run16)));

sort17 = sort(run17-mean(run17));
SWH17 = mean(sort17(round(2*length(run17)/3):length(run17)));

sort18 = sort(run18-mean(run18));
SWH18 = mean(sort18(round(2*length(run18)/3):length(run18)));
